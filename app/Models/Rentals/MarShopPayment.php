...
class MarShopPayment extends Model
{
  ...
  public function paymentList($ulbId)
  {
    ...
    public function listShopPaymentSummaryByPaymentMode($dateFrom,$dateTo){
      ...
      ->groupBy('pmt_mode','mar_shop_payments.payment_date','mar_shop_payments.user_id','mar_shop_payments.shop_category_id','mst.shop_type','ms.market_id','mm.market_name');
    }

...
class AgencyHoarding extends Model
{
    ...
    public function getFullDetails($request)
    {
        return self::select(
            ...
            ->leftJoin('hoarding_masters', function ($join) {
                $join->on('hoarding_masters.id', 'agency_hoardings.hoarding_id');
            })
    ...
    public function getByItsDetailsV2($req, $key, $refNo,)
    {
        return self::select(
            ...
            "agency_hoardings.parked",
            "agency_hoardings.btc_date",
            "agency_hoardings.btc_by",
            "agency_hoardings.btc_reason",
        ...
        END AS application_at"),
            ...
            ->leftjoin('hoarding_types', 'hoarding_types.id', 'hoarding_masters.hoarding_type_id')
            ->join('wf_roles', 'wf_roles.id', '=', 'agency_hoardings.current_role_id')
            ->leftjoin('m_circle', 'm_circle.id', '=', 'agency_hoardings.zone_mstr_id')
            ->leftjoin('ulb_ward_masters', 'ulb_ward_masters.id', '=', 'agency_hoardings.ward_mstr_id')
            ->join('ulb_masters', 'ulb_masters.id', '=', 'agency_hoardings.ulb_id')
    ...
    public function getRejectDocs($email)
    {
        return self::select(
            ...
            'hoarding_masters.hoarding_no',
            // "hoarding_types.type as hoarding_type",
            "agency_hoardings.btc_reason as reason",
            "agency_hoardings.btc_date",
            "agency_hoardings.btc_by",
            "agency_hoardings.mobile_no",
            "agency_hoardings.advertiser",

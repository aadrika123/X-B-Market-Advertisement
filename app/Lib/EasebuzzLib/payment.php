...
/*
    ...
    */
    function initiate_payment($params, $redirect, $merchant_key, $salt, $env){
        return $result = _payment($params, $redirect, $merchant_key, $salt, $env);
...
/*
    ...
    */
    function _payment($params, $redirect, $merchant_key, $salt, $env){
        ...
        $amount_validation = _amountValidation($postedArray['amount']);
...
/*
    ...
    */
    ...
    function _amountValidation($amount){
        $check_amount = true;
        if($amount <= 0) {
            return array(
                'status' => 0,
...
/*
    ...
    */
    function _emptyValidation($params, $salt){
        ...
        if (!empty($params['phone'])){
            if (strlen((string)$params['phone']) >= 20 || strlen((string)$params['phone']) < 5){
                $empty_value = 'Phone number should be less than 20 digits or greater than 4 and';
            }
        }
...
/*
    ...
    *
    */
    function ebzResponse($response_params, $salt_key){
